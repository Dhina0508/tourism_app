...
class RentalAcceptedReq extends StatefulWidget {
  RentalAcceptedReq({Key? key}) : super(key: key);

  @override
  State<RentalAcceptedReq> createState() => _RentalAcceptedReqState();
}

class _RentalAcceptedReqState extends State<RentalAcceptedReq> {
  List req = [];
  List req1 = [];
